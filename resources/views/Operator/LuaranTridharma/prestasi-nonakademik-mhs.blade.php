...
@section('title','Luaran dan Capaian Tri Dharma: Prestasi Non Akademik Mahasiswa | SIAPS FMIPA')
@section('content')
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <nav class="navbar navbar-light">
                                    <a class="navbar-brand">Prestasi Non Akademik yang Dicapai Mahasiswa Program Studi</a>
                                    ...
                                    <div class="table-responsive-xl">
                                        <table class="table table-borderless table-hover">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>1</td>
                                                    <td>Kompetisi Puisi Nasional</td>
                                                    <td>2019</td>
                                                ...
                                                <tr>
                                                    <td>2</td>
                                                    <td>Tournament UNW Euforic 2020</td>
                                                    <td>2020</td>
                                                    <td class="text-center">v</td>
                                                    <td class="text-center"></td>
                                                    <td class="text-center"></td>
