...
@section('title','Sumber Daya Manusia: Pengabdian kepada Masyarakat DTPS | SIAPS FMIPA')
@section('content')
                        ...
                        <div class="card">
                                ...
                                <div class="card text-center">
                                    <div class="card-header" style="background-color: white;">
                                        ...
                                        <li class="nav-item"  id="scnd">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link active" href="{{route('sdm-pkm')}}"  id="isian">PKM</a> 
                                            </li>
                                            <li class="nav-item"  id="scnd">
                            ...
                            <div class="card-body">
                                ...
                                <div class="alert alert-secondary" role="alert">
                                    Jumlah judul pengabdian kepada masyarakat (PkM) yang dilaksanakan oleh DTPS berdasarkan sumber pembiayaan yang relevan dengan bidang program studi pada TS-2 sampai dengan TS tersaji pada Tabel berikut.
                                </div>

                                <nav class="navbar navbar-light">
                                    <a class="navbar-brand">Data Pengabdian kepada Masyarakat DTPS</a>
                                        ...
                                        <table class="table table-borderless table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col" colspan="2" class="text-center">Jumlah Judul Pengabdian</th>
