...
@section('title','Home - Operator: Luaran & Capaian Tridharma | SIAPS FMIPA')
@section('content')
                                ...
                                <div class="card">
                                    <div class="card-header text-center" style="background-color: white;">
                                        <ul class="nav nav-tabs card-header-tabs">
                                          ...
                                          <li class="nav-item" id="isian">
                                            <a class="nav-link active" href="{{route('home-luaran')}}">Luaran & Capaian Tridharma</a>
                                          </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="alert" role="alert" id="note">
                                            ...
                                            <p>Generate Data Informasi Akademik dapat dilakukan dengan klik tombol ambil data Sistem Informasi Penelitian Pengabdian</p>
                                        </div>
                                        <br>
                                        <table class="table v-middle">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                        <p class="card-text">Luaran dan Capaian Tri Dharma</p>
                                                    </td>
                                                    <td colspan="3">
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                        <p class="card-text">IPK Lulusan</p>
                                                    </td>
                                                    <td colspan="3">
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                        <p class="card-text">Prestasi Akademik Mahasiswa</p>
                                                    </td>
                                                    <td colspan="3">
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                        <p class="card-text">Prestasi Non Akademik Mahasiswa</p>
                                                    </td>
                                                    <td colspan="3">
                                        ...
                                        <div class="text-right">
                                            <button type="button" class="btn" style="background-color: #00BEEB;color: white;">Ambil Data Sistem Informasi Penelitian Pengabdian</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
