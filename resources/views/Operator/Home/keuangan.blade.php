...
@section('title','Home - Operator: Keuangan Sarpras | SIAPS FMIPA')
@section('content')
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="alert" role="alert" id="note">
                                            ...
                                            <p>Generate Data Informasi Akademik dapat dilakukan dengan klik tombol ambil data Sistem Informasi Keuangan</p>
                                        </div>
                                        <br>
                                        <table class="table v-middle">
                                            <tbody>
                                        ...
                                        <div class="text-right">
                                            <button type="button" class="btn" style="background-color: #00BEEB;color: white;">Ambil Data Sistem Informasi Keuangan</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
